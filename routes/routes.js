...
router.post('/advisor_approve_reject_documents', adminRoutes.advisor_approve_reject_documents);
router.post('/advisor_assignto_consultant', adminRoutes.advisor_assignto_consultant);
...
// student
router.post('/student_upload_submit', 
    upload.fields([{
